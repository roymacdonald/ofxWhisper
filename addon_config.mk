...
meta:
	ADDON_NAME = ofxWhisper
	ADDON_DESCRIPTION = openFramworks addon for OpenAIs Whisper using whisper.cpp
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "ofx" "whisper" "whisper.cpp" "openAI" "voice to text"
	ADDON_URL = http://github.com/roymacdonald/ofxWhisper

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxSampleRate
	...
	ADDON_DATA = libs/whisper_cpp/models/*
